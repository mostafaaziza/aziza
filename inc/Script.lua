...
local inline = {{{text="-المطور اضـغـط هـنـآ ",url="https://t.me/UU_Fs"}}}
send_key(msg.sender_user_id_,'   [مبرامج المطور](https://t.me/UU_Fs)' ,nil,inline,msg.id_)
return false
end
...
܁𖠐︙الشروحات المطور(العزايزي الصغنن) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
܁𖠐︙مبرامج السورس
 @FlassTad
...
return sendMsg(msg.chat_id_,msg.id_,'𖤐 انت مجرد عضو معفن حقير مسمعش صوتك..😹❤️ 𖦹\n')   
end 
if Json_Info.result.status == "administrator" then
if Json_Info.result.can_change_info == true then
info = 'ꪜ' else info = '✘' end
...
elseif Text== "مصطفي" or Text== "العزايزي" then return  sendMsg(msg.chat_id_,msg.id_,"[مبرمج سورس العزايزي 𖠲](https://t.me/UU_Fs)")
elseif Text== "mostafa" or Text== "مصطفي محمد" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس المطور ❀](https://t.me/Mdo_Fs)")
elseif Text== "العزايزي الصغنن" or Text== "عالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[مبرمج سورس العزايزي 𖠲](https://t.me/UU_Fs)")
elseif Text== "اروي" or Text== "رورو" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس العزايزي 𖠲](https://t.me/rororola)")
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text== "سلام" or Text== "السلامم عليكم" or Text== "سلام عليكم" or Text=="سلامنن عليكم" or Text=="السلام عليكم" then 
  return sendMsg(msg.chat_id_,msg.id_,"وعلـيكم السلام يقلبي " )
  ...
  elseif Text== "حلو"  then return sendMsg(msg.chat_id_,msg.id_,"يحلات عيونك ..😻✨")
  ...
  elseif Text== "فينك" then return sendMsg(msg.chat_id_,msg.id_,"انا هنا ياحبيبي..🌚🖤")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ الجروب صاحب المكان واحنا ضيوفك..😂♥️🎶♔](https://t.me/al_aziza1)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مجرد عضو معفن حقير مسمعش صوتك..😹♥️𖦹](https://t.me/al_aziza1)")
end 
end 
