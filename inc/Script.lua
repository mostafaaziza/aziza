...
return redis:get(hack..":TEXT_SUDO") or '𖤐 لا توجد كليشه المطور .\n𖤐 يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end
...
if MsgText[1] == "رتبتي" then return '𖤐 ** رتبتك هنا ←  ( '..msg.TheRank..' )\n' end
...
local GetVerison = https.request( 'https://raw.githubusercontent.com/mostafaaziza/aziza/main/GetVersion.txt' ) or 0
...
return '𖤐 اصدار سورس المطور : *v'..version..'* \n'
end
...
send_key(msg.sender_user_id_,'   [قناة سورس : al_aziza1](https://t.me/al_aziza1)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "برامج السورس" and msg.type == "pv" then
local inline = {{{text="-المطور اضـغـط هـنـآ ",url="https://t.me/Mostafa_aziza"}}}
send_key(msg.sender_user_id_,'   [مبرامج المطور](https://t.me/Mostafa_aziza)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "قناه المبرامج" and msg.type == "pv" then
local inline = {{{text="مبرامج السورس اضـغـط هـنـآ ",url="https://t.me/al_aziza1"}}}
send_key(msg.sender_user_id_,'   [مبرامج السورس](https://t.me/al_aziza1)' ,nil,inline,msg.id_)
return false
end
...
܁𖠐︙ضع تكرار + العدد
╭—──── • ◈ • ──—–—╮
 مبرامج السورس ➣ @Mostafa_aziza
 قناه مبرامج ➣ @al_aziza1  
 ↺⋆ ⋆ ⋆  ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆
————————————————
 ⋆ يُـوزر المّـطور ⇽{ ]]..SUDO_USER..[[ } ✓ ]]
sendMsg(msg.chat_id_,msg.id_,text)
...
܁𖠐︙الشروحات المطور(العزايزي مصطفي) 
╭—──── • ◈ • ──—–—╮
܁𖠐︙مبرامج السورس
 @Mostafa_aziza
...
return [[
╭──── • 𝒎𝒐𝒔𝒕𝒂𝒇𝒂 • ────╮ 
么 [𝑺𝑶𝑼𝑹𝑪𝑬 𖡛](http://t.me/al_aziza1)
么 [𝑴𝒀 𝑩𝑶𝑻 𖡛“](https://t.me/sasa_m_bot)
么 [𝑴𝑶𝑺𝑻𝑨𝑭𝑨𖡛](http://t.me/Mostafa_aziza)
╰──── • 𝒎𝒐𝒔𝒕𝒂𝒇𝒂 • ────╯ 
...
if Black == 'welcome on' or Black == 'تفعيل التواصل' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل التواصل سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل التواصل')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل التواصل' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل التواصل سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل التواصل')
end
end
...
return sendMsg(msg.chat_id_,msg.id_,'𖤐 انت مجرد عضو معفن حقير مسمعش صوتك..😹❤️\n')   
end 
if Json_Info.result.status == "administrator" then
if Json_Info.result.can_change_info == true then
info = 'ꪜ' else info = '✘' end
...
elseif Text== "مصطفي" or Text== "العزايزي" then return  sendMsg(msg.chat_id_,msg.id_,"[مبرمج سورس العزايزي 𖠲](https://t.me/Mostafa_aziza)")
elseif Text== "باشا اسيوط" or Text== "مصطفي محمد" then return  sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس العزايزي ❀](https://t.me/Mostafa_aziza)")
elseif Text== "العزايزي مصطفي" or Text== "mostafa" then return  sendMsg(msg.chat_id_,msg.id_,"[مبرمج سورس العزايزي 𖠲](https://t.me/Mostafa_aziza)")
elseif Text== "رورو" or Text== "اروي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس العزايزي 𖠲](https://t.me/rororola)")
elseif Text== "العزايزه" or Text== "سورس العزايزي" then return  sendMsg(msg.chat_id_,msg.id_,"[افجر سورس مصري  𖠲](https://t.me/al_aziza1)")
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text== "بحبك."  then return sendMsg(msg.chat_id_,msg.id_,"بعشق ميتنمك..😹❤️")
  ...
  elseif Text== "حبيبي" or Text=="حبي" then return  sendMsg(msg.chat_id_,msg.id_,"اي ياروح قلبي..🥺💛")
  elseif Text== "حبيبتي" then return sendMsg(msg.chat_id_,msg.id_,"ف الخـاص مش هنا ياللي يحبك برص😒 ")
  ...
  elseif Text== "بتحبني" then return sendMsg(msg.chat_id_,msg.id_,"بعشـقك اوي ..🤗💜")
  elseif Text== "اقول" or Text=="اقولك" or Text=="اقولك." then return sendMsg(msg.chat_id_,msg.id_,"قول بحب الفضايح")
  elseif Text== "موجود" then return sendMsg(msg.chat_id_,msg.id_,"اه ياحبيبي موجود🥺❤️")
  elseif Text== "بحبك" then return sendMsg(msg.chat_id_,msg.id_,"بعشق ميتنمك..😂♥️💋")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت المطور ياباشا خدبوسه..😹💋](https://t.me/al_aziza1) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت المنشئ صاحب المكان ياعم العالم..😹❤️♔](https://t.me/al_aziza1)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه اعلي رتبه هنا يابا..😹💛๑](https://t.me/al_aziza1)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن ياحبيبي خد بالك من الجروب..💜🔥♘](https://t.me/al_aziza1)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت مجرد عضو معفن حقير مسمعش صوتك..😹❤️ 𖦹](https://t.me/al_aziza1)")
end 
end 
