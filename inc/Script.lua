...
⌔︙ اجنبي  ⍆
 ...
 — — — — — — — — —
𝙳𝙴𝚅 𖡇 : [Alamy 𖡼](https://t.me/alazizy)
𝙲𝙷 𖣲. :[source hacker 𖡶 ](https://t.me/BANDA1M)
]]
end
...
⌔︙كلب بلدي
 — — — — — — — — —
𝙳𝙴𝚅 𖡇 : [Alamy 𖡼](https://t.me/alazizy)
𝙲𝙷 𖣲. :[source hacker𖡶 ](https://t.me/BANDA1M)
]]
end
...
–––––––––––––––––––––––––––––
𝙳𝙴𝚅 𖡇 : [𝙰𝙻𝙰𝙼𝚈 𖡼](https://t.me/alazizy)
𝙳𝙴𝚅 𖡇 : [𝙰𝙻𝙻𝙰𝙼 𖡼](https://t.me/M_A_L_L_A_M)
𝙲𝙷 𖣲. :[source hacker1𖡶 ](https://t.me/BANDA1M1)
...
elseif Text== "العالمي" or Text== "عالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس الباندا ❅](https://t.me/alazizy)")
elseif Text== "محمد سمير" or Text== "سمير " then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس الباندا ❅](https://t.me/Best_roma5)")
elseif Text== "وليد" or Text== "وليدد " then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس الباندا ❅](https://t.me/Lookacv)")
elseif Text== "سام" or Text== "منه" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس الباندا ❅](https://t.me/XxxMalificentxxX)")
elseif Text== "مودي" or Text== "رسلان" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس الباندا ♲](https://t.me/moody52)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/BANDA1M) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/BANDA1M)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/BANDA1M)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/BANDA1M)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/BANDA1M)")
end 
end 
